---
title: "Climate Change Analysis: A Data Visualisation Dashboard (By Diksha Joshi)"
output: 
...
This dashboard presents information from various sources regarding different aspects of climate change.

First, viewers can see a direct representation of global warming itself, which is shown by the rise in global temperature. Then, visualisations of the emission of greenhouse gases, which is the leading cause of climate change and global warming, are presented. Finally, a couple effects of climate changes are included.
